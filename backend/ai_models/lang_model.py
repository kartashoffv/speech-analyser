...
prompt = ChatPromptTemplate.from_template(
    """Ответьте на вопрос на основе следующей инструкции:
...
def txt_classifier(script: str) -> str:
    """Определяет, содержатся ли в переданном скрипте записи ошибки, согласно регламенту служебных переговоров.

    Args:
        script (str): запись скрипта.
